        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <article className="prose prose-lg max-w-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
              <div className="bg-surface rounded-xl p-6">
                <h4 className="font-semibold text-ink mb-3 text-lg">
                  🎨 Pintura al Óleo
                </h4>
            ...
            <div className="bg-white border border-line rounded-xl p-6 mb-8">
              <ul className="space-y-3 text-ink-body">
                <li className="flex items-start">
                  <span className="text-brand mr-2 font-bold">1.</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 my-8">
              <div className="text-center p-4 border border-line rounded-lg">
                <div className="text-3xl mb-2">🎨</div>
                <h4 className="font-semibold text-ink mb-2">Pigmentos</h4>
                <p className="text-sm text-ink-muted">Óleos profesionales de alta permanencia y luminosidad</p>
              </div>
              <div className="text-center p-4 border border-line rounded-lg">
                <div className="text-3xl mb-2">🖼️</div>
                <h4 className="font-semibold text-ink mb-2">Soportes</h4>
                <p className="text-sm text-ink-muted">Telas naturales de algodón y lino de primera calidad</p>
              </div>
              <div className="text-center p-4 border border-line rounded-lg">
                <div className="text-3xl mb-2">✨</div>
                <h4 className="font-semibold text-ink mb-2">Acabados</h4>
                <p className="text-sm text-ink-muted">Barnices de protección UV para durabilidad</p>
              </div>
            </div>
            ...
            <div className="space-y-3 mb-8">
              <div className="flex items-start p-4 bg-surface rounded-lg">
                ...
                <div>
                  <strong className="text-brand">Coleccionistas privados:</strong>
                  <span className="text-ink-body"> Obras únicas según preferencias de tema, tamaño y paleta cromática</span>
                </div>
              </div>
              <div className="flex items-start p-4 bg-surface rounded-lg">
                <span className="text-brand mr-3">→</span>
                <div>
                  <strong className="text-brand">Proyectos corporativos:</strong>
                  <span className="text-ink-body"> Obras de gran formato para oficinas, hoteles y espacios comerciales</span>
                </div>
              </div>
              <div className="flex items-start p-4 bg-surface rounded-lg">
                <span className="text-brand mr-3">→</span>
                <div>
                  <strong className="text-brand">Decoradores de interiores:</strong>
                  <span className="text-ink-body"> Asesoría y creación de obras específicas para proyectos residenciales</span>
                </div>
              </div>
              <div className="flex items-start p-4 bg-surface rounded-lg">
                <span className="text-brand mr-3">→</span>
                <div>
                  <strong className="text-brand">Regalos especiales:</strong>
                  <span className="text-ink-body"> Obras personalizadas para ocasiones significativas</span>
                </div>
              </div>
            </div>
          </article>
          ...
          <div className="mt-12 pt-8 border-t border-line">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                <span className="font-medium text-ink">Galería de Pinturas →</span>
                <p className="text-sm text-ink-muted mt-1">Obras en óleo creadas en el taller</p>
              </Link>
              <Link
                href="/contacto"
                className="block p-4 rounded-lg border border-line hover:border-brand hover:bg-surface transition-colors"
              >
                ...
                <p className="text-sm text-ink-muted mt-1">Consultas y encargos</p>
              </Link>
            </div>
          </div>
        </div>
